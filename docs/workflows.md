...
### `/review`
- **Loads:** for monthly lightweight review, `knowledge/product/roadmap.md`, `knowledge/product/features/progress-dashboard.md`, `decisions/INDEX.md`, `docs/CHANGELOG.md`, and `knowledge/strategy.md`; for full review, everything modified in the last 30 days plus full hypothesis and decision indexes.
...
- **Conversational:** "Run a monthly lightweight review", "Run a full review", or "Let's clean up the brain."
