...
- lec内测小学量级：固定统计小学、LEC内测、1 元、target 中该范围最新期次；报量合计和进量合计必须来自统一 Summary；YZY 4400、WC 1800、RQ 1000、JJ 1000；四个指定 last_from 外的 Summary 进量差额列为“其他”；实际占比按 Summary 进量合计计算。
